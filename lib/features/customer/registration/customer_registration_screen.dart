  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Sign Up', style: AppTextStyles.headingLarge?.copyWith(color: theme.textColor)),
        leading: IconButton(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Create Account ✨', style: AppTextStyles.displayLarge?.copyWith(fontSize: 24, color: theme.textColor)),
              const SizedBox(height: 8),
              Text('Sign up to book your salon services', style: AppTextStyles.tagline?.copyWith(color: theme.mutedTextColor)),
